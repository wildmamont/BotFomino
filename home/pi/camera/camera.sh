...
rm /home/telegramd/video-livestream.h264 > /dev/null 2>/dev/null
rm /home/telegramd/video-photo00?.jpg> /dev/null 2>/dev/null
...
avconv  -vsync passthrough -f h264 -i /home/telegramd/video-livestream.h264  -f image2 /home/telegramd/video-photo%03d.jpg  > /dev/null 2>/tmp/avconv.txt
